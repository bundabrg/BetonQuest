 ...
 */
package pl.betoncraft.betonquest.v1_13_R1.compatibility.effectlib;

import de.slikey.effectlib.EffectManager;
import pl.betoncraft.betonquest.BetonQuest;
import pl.betoncraft.betonquest.v1_13_R1.compatibility.LocalCompatibility;
import pl.betoncraft.betonquest.compatibility.Integrator;
import pl.betoncraft.betonquest.v1_13_R1.compatibility.citizens.CitizensParticle;
...
public class EffectLibIntegrator implements Integrator {
    ...
    public void hook() {
        ...
        if (LocalCompatibility.getInstance().getHooked().contains("Citizens"))
