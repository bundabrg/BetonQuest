 ...
 */
package pl.betoncraft.betonquest.v1_12_R1.compatibility.effectlib;

import de.slikey.effectlib.EffectManager;
import pl.betoncraft.betonquest.BetonQuest;
import pl.betoncraft.betonquest.compatibility.Compatibility;
import pl.betoncraft.betonquest.compatibility.Integrator;
import pl.betoncraft.betonquest.v1_12_R1.compatibility.citizens.CitizensParticle;
...
public class EffectLibIntegrator implements Integrator {
    ...
    public void hook() {
        ...
        if (Compatibility.getInstance().getHooked().contains("Citizens"))
