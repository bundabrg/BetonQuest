 ...
 */
package pl.betoncraft.betonquest.v1_12_R1.compatibility.citizens;

import pl.betoncraft.betonquest.BetonQuest;
import pl.betoncraft.betonquest.compatibility.Compatibility;
import pl.betoncraft.betonquest.compatibility.Integrator;
import pl.betoncraft.betonquest.v1_12_R1.compatibility.protocollib.NPCHider;
import pl.betoncraft.betonquest.v1_12_R1.compatibility.protocollib.UpdateVisibilityNowEvent;
...
public class CitizensIntegrator implements Integrator {
    ...
    public void hook() {
        ...
        if (Compatibility.getInstance().getHooked().contains("EffectLib"))
            new CitizensParticle();

        // if ProtocolLib is hooked, start NPCHider
        if (Compatibility.getInstance().getHooked().contains("ProtocolLib")) {
            NPCHider.start();
    ...
    @Override
    public void reload() {
        if (Compatibility.getInstance().getHooked().containsAll(Arrays.asList("Citizens", "EffectLib"))) {
